...
def comptar_estudiants_materia(notes, matèria):
    return len([estudiant for estudiant in notes if matèria in notes[estudiant]])

def comptar_estudiants_materia_v2(notes, matèria):  
    comptador = 0
...
# print(f"Hi ha {comptar_estudiants_materia(notes_estudiants, 'Matemàtiques')} estudiant(s) matriculat(s) a la matèria Matemàtiques.")    
